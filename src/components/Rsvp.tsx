...
export default function Rsvp() {
  ...
  return (
    <section id="rsvp" ref={ref} className={revealed ? 'revealed' : ''}>
      ...
      <p style={{ fontFamily: "'Gowun Batang', serif", fontSize: '1.25rem', letterSpacing: '3px', color: 'var(--text-light)', marginBottom: '32px', ...a(80) }}>참석 여부</p>
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ position: 'relative', textAlign: 'center', marginBottom: '20px' }}>
              <span style={{ fontFamily: "'Gowun Batang', serif", fontSize: '1.1rem', color: 'var(--text-main)' }}>
                참석 의사 전달
              </span>
              <button
                onClick={close}
